...
//	{ modelname;     snd,	  rldsnd,  rldtime, atkdelay,  dmg, rngstart, rngend, rngm,psd,ptt,spr,kick,magsz,mkrot,mkback,rcoil,maxrcl,rca,pushf; auto;}
	...
	{ "shotgun",    S_SHOTGUN,  S_RSHOTGUN,  750,   200,    10,    4,   16,    4,   0,   0,  1,   12,    7,   9,  5,    60,    70,      5, 2,   false},
	...
	{ "bow",        S_NULL,     S_RASSAULT, 2000,   120,   300,    0,   24,  290,   0,   0, 84,    3,    1,   3,  1,    48,    50,      0, 4,   false},
};
