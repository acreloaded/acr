...
enum { PR_CLEAR = 0, PR_ASSIST, PR_SPLAT, PR_HS, PR_KC, PR_KD, PR_HEALSELF, PR_HEALTEAM, PR_HEALENEMY, PR_HEALWOUND, PR_HEALEDBYTEAMMATE, PR_ARENA_WIN, PR_ARENA_WIND, PR_ARENA_LOSE, PR_MAX };

#define HEALTHPRECISION 1
#define HEALTHSCALE 10 // 10 ^ 1
#define STARTHEALTH (100 * HEALTHSCALE)
#define MAXHEALTH (120 * HEALTHSCALE)
#define MAXZOMBIEROUND 2
