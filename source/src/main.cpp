...
int main(int argc, char **argv)
{
	...
	if(!quitdirectly)
	{
		...
		scoremenu = addmenu("score", "score\tfrag\tassist\tdeath\tratio\tpj\tping\tcn\tlvl\tname", false, renderscores, NULL, false, true);
		teammenu = addmenu("team score", "score\tfrag\tassist\tdeath\tratio\tpj\tping\tcn\tlvl\tname", false, renderscores, NULL, false, true);
