...
int main(int argc, char **argv)
{
	...
	if(!quitdirectly)
	{
		...
		scoremenu = addmenu("score", "score\tfrag\tassist\tdeath\tratio\tpj\tping\tcn\tsk\tname", false, renderscores, NULL, false, true);
		teammenu = addmenu("team score", "score\tfrag\tassist\tdeath\tratio\tpj\tping\tcn\tsk\tname", false, renderscores, NULL, false, true);
		ctfmenu = addmenu("ctf score", "score\tflag\tfrag\tassist\tdeath\tratio\tpj\tping\tcn\tsk\tname", false, renderscores, NULL, false, true);
