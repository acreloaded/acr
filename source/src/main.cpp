...
int main(int argc, char **argv)
{
	...
	if(!quitdirectly)
	{
		...
		scoremenu = addmenu("score", "score\tfrags\tassists\tdeath\tratio\tpj\tping\tcn\tname", false, renderscores, NULL, false, true);
		teammenu = addmenu("team score", "score\tfrags\tassists\tdeath\tratio\tpj\tping\tcn\tname", false, renderscores, NULL, false, true);
		ctfmenu = addmenu("ctf score", "score\tflags\tfrags\tassists\tdeath\tratio\tpj\tping\tcn\tname", false, renderscores, NULL, false, true);
