...
#define PROTOCOL_VERSION 2111		   // bump when protocol changes
...
enum{
	...
	N_INITCLIENT, N_INITAI, N_SETTEAM, N_RESUME, N_MAPIDENT, N_DISC, N_DELBOT, // sent after (dis)connection
	N_CLIENT, N_POS, N_SOUND, N_PINGPONG, N_PINGTIME, // automatic from client
	N_TEXT, N_WHOIS, N_WHOISINFO, N_NEWNAME, N_SKIN, N_SWITCHTEAM, // user-initiated
	...
	N_SG, N_SCOPE, N_SUICIDE, N_QUICKSWITCH, N_SWITCHWEAP, N_PRIMARYWEAP, N_FALL, N_THROWNADE, N_THROWKNIFE, // server directly handled
...
enum { SA_KICK = 0, SA_BAN, SA_REMBANS, SA_MASTERMODE, SA_AUTOTEAM, SA_FORCETEAM, SA_GIVEADMIN, SA_MAP, SA_RECORDDEMO, SA_STOPDEMO, SA_CLEARDEMOS, SA_SERVERDESC, SA_SHUFFLETEAMS, SA_SUBDUE, SA_REVOKE, SA_SPECT, SA_NUM};
