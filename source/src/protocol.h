...
#define PROTOCOL_VERSION 2113		   // bump when protocol changes
...
enum{
	...
	N_POINTS, N_KILL, N_DAMAGE, N_REGEN, N_PROJPUSH, N_KNIFEADD, N_KNIFEREMOVE, N_BLEED, N_STICK, N_MARTYRDOM, // server to client
	// gameplay
