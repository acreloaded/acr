...
#define PROTOCOL_VERSION 2100		   // bump when protocol changes
...
enum{
	SV_SERVINFO = 0, SV_WELCOME, SV_POS, SV_TEXT, SV_SOUND, SV_CDIS,
	SV_INITCLIENT, SV_NEWNAME, SV_SKIN,
	SV_SHOOT, SV_EXPLODE, SV_SUICIDE, SV_AKIMBO, SV_RELOAD,
	SV_DIED, SV_DAMAGE, SV_REGEN, SV_HITPUSH, SV_SHOTFX, SV_THROWNADE,
	SV_TRYSPAWN, SV_SPAWNSTATE, SV_SPAWN, SV_FORCEDEATH, SV_RESUME,
	SV_TIMEUP, SV_EDITENT, SV_MAPRELOAD, SV_NEXTMAP,
	SV_MAPCHANGE, SV_ITEMSPAWN, SV_ITEMACC,
	SV_PINGPONG, SV_PINGTIME,
	...
	SV_DROPFLAG, SV_FLAGINFO, SV_FLAGMSG, SV_FLAGCNT,
	SV_ARENAWIN,
	SV_SETROLE, SV_CURRENTSOP, SV_SOPCHANGE,
	SV_CALLVOTE, SV_CALLVOTEERR, SV_VOTE, SV_VOTERESULT,
	SV_SETTEAM, SV_SWITCHTEAM,
	SV_WHOIS,
	SV_LISTDEMOS, SV_DEMO, SV_DEMOPLAYBACK,
	SV_CONNECT,
	SV_CLIENT,
	SV_EXTENSION,
	SV_MAPIDENT, SV_NUM
