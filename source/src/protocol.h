...
enum{
	...
	N_INITCLIENT, N_INITAI, N_SETTEAM, N_RESUME, N_MAPIDENT, N_DISC, N_DELAI, // sent after (dis)connection
	...
	N_RICOCHET, N_POINTS, N_KILL, N_DAMAGE, N_REGEN, N_PROJPUSH, N_KNIFEADD, N_KNIFEREMOVE, N_BLEED, N_STICK, N_STREAKREADY, N_STREAKUSE, // server to client
	// gameplay
...
enum { PHYS_FALL = 0, PHYS_HARDFALL, PHYS_JUMP, PHYS_AKIMBOOUT, PHYS_NOAMMO };
