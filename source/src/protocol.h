...
#define PROTOCOL_VERSION 140            // bump when protocol changes (use negative numbers for mods!)
...
enum
{
    ...
    SV_TEXT, SV_TYPING, SV_WHOIS, SV_SWITCHNAME, SV_SWITCHSKIN, SV_THIRDPERSON, SV_LEVEL, SV_SETTEAM, // user-initiated
