...
enum
{
    ...
    SV_TEXT, SV_TEXTPRIVATE, SV_WHOIS, SV_SWITCHNAME, SV_SWITCHSKIN, SV_SETTEAM, // user-initiated
    SV_CALLVOTE, SV_CALLVOTEERR, SV_VOTE, SV_VOTEREMAIN, SV_VOTERESULT, // votes
