...
extern void dodamage(int damage, playerent *pl, playerent *actor, int weapon, int style, bool local = false);
extern void dokill(playerent *pl, playerent *act, int weapon, int style);
