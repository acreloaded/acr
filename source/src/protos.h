...
extern void addobit(playerent *actor, int weap, bool headshot, bool gib, playerent *target);
...
enum { WP_KNIFE = 0, WP_BOMB, WP_EXP, WP_KILL, WP_ESCORT, WP_DEFEND, WP_GRAB, WP_ENEMY, WP_FRIENDLY, WP_STOLEN, WP_RETURN, WP_AIRSTRIKE, WP_NUKE, WP_NUM };
...
extern void connectcheck(int cn, enet_uint32 ip, const char *nick);
