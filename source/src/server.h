...
//	{ modelname;     snd,	  rldsnd,  rldtime, atkdelay,  dmg, rngstart, rngend, rngm,psd,ptt,spr,kick,magsz,mkrot,mkback,rcoil,maxrcl,rca,pushf; auto;}
	...
	{ "subgun",     S_SUBGUN,   S_RSUBGUN,  2400,   67,     40,   32,   80,   22,   0,   0, 70,    4,   32,   1,  3,    27,    45,     65, 1,   true },
	...
	{ "assault",    S_ASSAULT,  S_RASSAULT, 2100,   73,     32,   40,  100,   12,   0,   0, 60,    3,   30,   0,  3,    25,    38,     60, 1,   true },
	{ "grenade",    S_NULL,     S_NULL,     1000,   650,   250,    0,   32,  225,  20,   6,  1,    1,    1,   3,  1,     0,    0,       0, 4,   false},
	{ "pistol",     S_PISTOL,   S_RAKIMBO,  1400,   80,     40,   45,  128,   17,   0,   0, 56,    8,   24,   6,  2,    28,    48,     70, 2,   true },
	...
	{ "bow",        S_BOW,      S_NULL,     2000,   120,   250,    0,   24,  240,   0,   0,128,    3,    1,   3,  1,    48,    50,      0, 4,   false},
};
