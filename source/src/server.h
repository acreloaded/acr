...
//  { modelname;    sound,      reload,    reloadtime, attackdelay, damage, range, endrange, rangeminus, projspeed, part, spread, spreadrem, kick, addsize, magsize, mdl_kick_rot, mdl_kick_back, recoil, maxrecoil, recoilangle, pushfactor; auto;}
    ...
    { "pistol",     S_PISTOL,   S_RPISTOL,       1400,          90,     27,    24,       90,         10,         0,    0,     90,        90,    9,      12,      13,            6,             2,     32,        48,          70,          1, false},
    { "shotgun",    S_SHOTGUN,  S_RSHOTGUN,       750,         200,     10,     6,       16,          7,         0,    0,    295,         5,   12,       1,       8,            9,             5,     60,        70,           5,          2, false},
    { "subgun",     S_SUBGUN,   S_RSUBGUN,       2400,          67,     27,    32,       80,         16,         0,    0,     70,        93,    4,      32,      33,            1,             3,     27,        45,          65,          1, true },
    ...
    { "assault",    S_ASSAULT,  S_RASSAULT,      2100,          73,     24,    45,       92,          8,         0,    0,     65,        95,    3,      30,      31,            0,             3,     25,        42,          60,          1, true },
    ...
    { "heal",       S_SUBGUN,   S_NULL,          1200,         100,     15,     4,        8,          8,         0,    0,     50,         1,    1,      10,      11,            0,             0,     10,        20,           8,          4, true },
    { "sword",      S_SWORD,    S_NULL,             0,         480,     90,     7,        9,         81,         0,    0,      1,         0,    1,       0,       1,            0,             2,      0,         0,           0,          0, true },
    { "rpg",        S_RPG,      S_NULL,          2000,         120,     17,     0,       40,         18,         0,    0,    200,        50,    3,       1,       1,            3,             1,     48,        50,           0,          2, false},
    { "assault2",   S_ASSAULT2, S_RASSAULT2,     2000,         100,     35,    48,      120,         12,         0,    0,    150,        94,    3,      30,      31,            0,             3,     30,        47,          62,          1, true },
