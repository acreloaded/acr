...
//	{ modelname;     snd,	  rldsnd,  rldtime, atkdelay,  dmg, rngstart, rngend, rngm,psd,ptt,spr,sprrem,kick,addsz,magsz,mkrot,mkback,rcoil,maxrcl,rca,pushf; auto;}
	...
	{ "sniper",     S_SNIPER,   S_RSNIPER,  2000,   120,   120,    1,    2,   75,   0,   0,235,    100,   14,   10,   11,   4,  4,    59,    68,     75, 2,   false},
	...
	{ "rpg",        S_RPG,      S_NULL,     2000,   120,   175,    0,   20,  165,   0,   0,200,     50,    3,    1,    1,   3,  1,    48,    50,      0, 2,   false},
};
