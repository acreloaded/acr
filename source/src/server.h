...
//	{ modelname;    sound,	    reload,    reloadtime, attackdelay, damage, range, endrange, rangeminus, projspeed, part, spread, spreadrem, kick, addsize, magsize, mdl_kick_rot, mdl_kick_back, recoil, maxrecoil, recoilangle, pushfactor; auto;}
	...
	{ "pistol",     S_PISTOL,   S_RPISTOL,       1400,          90,     36,    24,       90,         17,         0,    0,     90,        90,    9,      12,      13,            6,             2,     35,        50,          70,          1, false},
	{ "shotgun",    S_SHOTGUN,  S_RSHOTGUN,       750,         200,     10,     6,       16,          7,         0,    0,    295,         5,   12,       1,       8,            9,             5,     90,       105,           5,          2, false},
	{ "subgun",     S_SUBGUN,   S_RSUBGUN,       2400,          67,     36,    32,       80,         21,         0,    0,     70,        93,    4,      32,      33,            1,             3,     50,        65,          65,          1, true },
	{ "sniper",     S_SNIPER,   S_RSNIPER,       2000,         120,     45,    70,      110,         10,         0,    0,    235,        96,   14,      10,      11,            4,             4,     59,        68,          75,          2, false},
	{ "bolt",       S_BOLT,     S_RBOLT,         2000,        1500,    120,    80,      130,         45,         0,    0,    250,        97,   36,       8,       9,            4,             4,     86,        90,          80,          3, false},
	{ "assault",    S_ASSAULT,  S_RASSAULT,      2100,          73,     32,    45,       92,         10,         0,    0,     65,        95,    3,      30,      31,            0,             3,     40,        55,          65,          1, true },
	{ "grenade",    S_NULL,     S_NULL,          1000,         650,    230,     0,       27,        225,        20,    6,      1,         0,    1,       0,       1,            3,             1,      0,         0,           0,          3, false},
	{ "pistol",     S_PISTOL,   S_RAKIMBO,       1400,          80,     36,    30,       90,         17,         0,    0,     60,         0,    8,      24,      26,            6,             2,     40,        55,          72,          2, true },
	{ "heal",       S_SUBGUN,   S_NULL,          1200,         100,     20,     4,        8,         10,         0,    0,     50,         1,    1,      10,      11,            0,             0,     20,        30,           8,          4, true },
	{ "sword",      S_SWORD,    S_NULL,             0,         480,     90,     7,        9,         81,         0,    0,      1,         0,    1,       0,       1,            0,             2,      0,         0,           0,          0, true },
	{ "rpg",        S_RPG,      S_NULL,          2000,         120,    170,     0,       18,        160,         0,    0,    200,        50,    3,       1,       1,            3,             1,     95,       100,          15,          2, false},
	{ "assault2",   S_ASSAULT2, S_RASSAULT2,     2000,         100,     46,    48,      120,         16,         0,    0,    150,        94,    3,      30,      31,            0,             3,     60,        75,          70,          1, true },
