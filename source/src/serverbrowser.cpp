...
{
    string request;
    sprintf(request, "http://%s:%u%s/c?build_defs=%lu&guid32=%lu", masterbase, masterport, masterpath, getbuildtype(), genguid(234534, 546456456U, 345345453, "3458739874jetrgjk"));
