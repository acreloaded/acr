...
// externs from vertmodel.h
extern int dynshadowsize, aadynshadow, saveshadows,  dynshadowquad,  shadowyaw;
extern vec shadowpos, shadowdir;
extern int dbgstenc, dbgvlight,  mdldlist;
extern vec modelpos;
extern float modelyaw, modelpitch;
