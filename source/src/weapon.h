...
enum { WEAP_KNIFE = 0, WEAP_PISTOL, WEAP_SHOTGUN, WEAP_SUBGUN, WEAP_SNIPER, WEAP_BOLT, WEAP_ASSAULT, WEAP_GRENADE, WEAP_AKIMBO, WEAP_HEAL, WEAP_WAVE, WEAP_BOW, NUMGUNS };
